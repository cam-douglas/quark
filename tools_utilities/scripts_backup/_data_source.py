...
class BaseDataSource(Generic[T], ABC):
    ...
    def read_data(self, *args, **kwargs) -> T:
        """Read data from data_knowledge.datasets_knowledge.datasets_knowledge.datasets source and return the specified type.
...
class PySparkDataSource(BaseDataSource[DataFrame], ABC):
    ...
    def read_data(
        ...
        """Read data from data_knowledge.datasets_knowledge.datasets_knowledge.datasets source and convert the data to Spark DataFrame.
