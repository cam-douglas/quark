...
def list_scorers(*, experiment_id: Optional[str] = None) -> list[Scorer]:
    ...
    """
    try:
        from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsbricks.agents.scorers import list_scheduled_scorers
...
def get_scorer(*, name: str, experiment_id: Optional[str] = None) -> Scorer:
    ...
    """
    try:
        from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsbricks.agents.scorers import get_scheduled_scorer
    except ImportError as e:
        raise ImportError(_ERROR_MSG) from e
...
def delete_scorer(
    *,
    ...
    """
    try:
        from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsbricks.agents.scorers import delete_scheduled_scorer
    except ImportError as e:
        raise ImportError(_ERROR_MSG) from e
...
def add_registered_scorer(
    *,
    ...
    try:
        from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsbricks.agents.scorers import add_scheduled_scorer
    except ImportError as e:
        raise ImportError(_ERROR_MSG) from e
...
def update_registered_scorer(
    *,
    ...
    try:
        from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsbricks.agents.scorers import update_scheduled_scorer
    except ImportError as e:
        raise ImportError(_ERROR_MSG) from e
