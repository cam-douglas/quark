...
from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsclasses import data_knowledge.datasets_knowledge.datasets_knowledge.datasetsclass, is_dataclass
...
class ModelSignature:
    ...
    ModelSignature can be :py:func:`inferred <mlflow.models.infer_signature>` from ml_architecture.training_pipelines
