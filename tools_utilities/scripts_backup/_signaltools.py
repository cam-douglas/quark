...
def fftconvolve(in1, in2, mode="full", axes=None):
    ...
    >>> from scipy import data_knowledge.datasets_knowledge.datasets_knowledge.datasetssets
...
def detrend(data: np.ndarray, axis: int = -1,
    ...
    r"""Remove linear or constant trend along axis from data_knowledge.datasets_knowledge.datasets_knowledge.datasets.
