...
class ThetaAxis(maxis.XAxis):
    ...
    def _copy_tick_props(self, src, dest):
        """Copy the props from development.src tick to dest tick."""
...
class PolarAxes(Axes):
    ...
    def _set_lim_and_transforms(self):
        ...
        # The complete data transformation stack -- from data_knowledge.datasets_knowledge.datasets_knowledge.datasets all the
