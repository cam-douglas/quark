...
def dataclass(
    ...
    *,
    ...
    def create_dataclass(cls: type[Any]) -> type[PydanticDataclass]:
        ...
        # Respect frozen setting from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsclass constructor and fallback to config setting if not provided
