...
class LastPatchInstallationSummary(_serialization.Model):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.reboot_status: Optional[Union[str, "_models.RebootStatus"]] = None
...
class VirtualMachineAssessPatchesResult(_serialization.Model):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.patches: Optional[List["_models.VirtualMachineSoftwarePatchProperties"]] = None
        self.error: Optional["_models.ApiError"] = None
...
class VirtualMachineSoftwarePatchProperties(_serialization.Model):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.reboot_behavior: Optional[Union[str, "_models.SoftwareUpdateRebootBehavior"]] = None
