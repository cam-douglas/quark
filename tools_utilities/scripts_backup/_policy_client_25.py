...
class PolicyClient:
    ...
    :vartype variables:
     azure.mgmt.resource.policy.v2022_08_01_preview.aio.operations.VariablesOperations
    :ivar variable_values: VariableValuesOperations operations
    :vartype variable_values:
     azure.mgmt.resource.policy.v2022_08_01_preview.aio.operations.VariableValuesOperations
