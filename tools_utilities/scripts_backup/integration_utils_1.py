...
import sys
import tempfile
from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsclasses import asdict, fields
...
def run_hp_search_ray(trainer, n_trials: int, direction: str, **kwargs) -> BestRun:
    ...
    def dynamic_modules_import_trainable(*args, **kwargs):
        ...
        if is_datasets_available():
            import data_knowledge.datasets_knowledge.datasets_knowledge.datasetssets.load
