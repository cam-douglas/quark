...
from data_knowledge.datasets_knowledge.datasets_knowledge.datasetssets import config
from data_knowledge.datasets_knowledge.datasets_knowledge.datasetssets.features.features import FeatureType, _visit, _visit_with_path, _VisitPath, require_storage_cast
from data_knowledge.datasets_knowledge.datasets_knowledge.datasetssets.utils.file_utils import readline
    ...
    def _split_generators(self, dl_manager):
        ...
        for split_name, files in data_files.items():
            ...
            if do_analyze:  # drop_metadata is None or False, drop_labels is None or False
                ...
                if add_labels:
                    logger.info("Adding the labels inferred from data_knowledge.datasets_knowledge.datasets_knowledge.datasets directories to the dataset's features...")
                if add_metadata:
