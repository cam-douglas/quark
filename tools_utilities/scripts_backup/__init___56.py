"""
Non-separable transforms that map from data_knowledge.datasets_knowledge.datasets_knowledge.datasets space to screen space.

Projections are defined as `~.axes.Axes` subclasses.  They include the
following elements:

- A transformation from data_knowledge.datasets_knowledge.datasets_knowledge.datasets coordinates into display coordinates.
