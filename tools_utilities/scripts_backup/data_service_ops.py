...
from tensorflow.core.protobuf import data_knowledge.datasets_knowledge.datasets_knowledge.datasets_service_pb2
...
def _from_dataset_id(processing_mode,
  ...
  def _get_element_spec():
    ...
    try:
      ...
      # This error results from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsset ID not found. A more appropriate error
