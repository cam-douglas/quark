...
def heatmap(
    ...
    **kwargs
    ...
    cmap : matplotlib colormap name or object, or list of colors, optional
        The mapping from data_knowledge.datasets_knowledge.datasets_knowledge.datasets values to color space. If not provided, the
...
class ClusterGrid(Grid):
    ...
    def format_data(self, data, pivot_kws, z_score=None,
                    standard_scale=None):
        """Extract variables from data_knowledge.datasets_knowledge.datasets_knowledge.datasets or use directly."""
