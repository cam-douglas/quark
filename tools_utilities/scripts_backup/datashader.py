...
import data_knowledge.datasets_knowledge.datasets_knowledge.datasetsshader as ds
import data_knowledge.datasets_knowledge.datasets_knowledge.datasetsshader.reductions as rd
import data_knowledge.datasets_knowledge.datasets_knowledge.datasetsshader.transfer_functions as tf
import numpy as np
import pandas as pd
import param
import xarray as xr
from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsshader.colors import color_lookup
...
class trimesh_rasterize(aggregate):
    ...
    def _precompute(self, element, agg):
        from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsshader.utils import mesh
