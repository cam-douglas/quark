...
class Trimesh(Geometry3D):
    ...
    def face_normals(self) -> NDArray[float64]:
        ...
        # get faces from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsstore
    ...
    def update_faces(self, mask: ArrayLike) -> None:
        ...
        # from data_knowledge.datasets_knowledge.datasets_knowledge.datasets to cache, get faces from cache.
