...
class LineModelND(BaseModel):
    ...
    def estimate(self, data):
        """Estimate line model from data_knowledge.datasets_knowledge.datasets_knowledge.datasets.
...
class CircleModel(BaseModel):
    ...
    def estimate(self, data):
        """Estimate circle model from data_knowledge.datasets_knowledge.datasets_knowledge.datasets using total least squares.
...
class EllipseModel(BaseModel):
    ...
    def estimate(self, data):
        """Estimate ellipse model from data_knowledge.datasets_knowledge.datasets_knowledge.datasets using total least squares.
