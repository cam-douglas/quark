...
class MDS(BaseEstimator):
    ...
    dissimilarity_matrix_ : ndarray of shape (n_samples, n_samples)
        ...
        - either uses a custom dissimilarity matrix by setting `dissimilarity`
          to 'precomputed';
        - or constructs a dissimilarity matrix from data_knowledge.datasets_knowledge.datasets_knowledge.datasets using
          Euclidean distances.
    ...
    def fit_transform(self, X, y=None, init=None):
        ...
        if X.shape[0] == X.shape[1] and self.dissimilarity != "precomputed":
            warnings.warn(
                ...
                " dissimilarity matrix from data_knowledge.datasets_knowledge.datasets_knowledge.datasets. To use a custom "
