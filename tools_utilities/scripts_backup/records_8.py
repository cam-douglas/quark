...
class recarray(ndarray):
    ...
    See Also
    --------
    numpy.rec.fromrecords : Construct a record array from data_knowledge.datasets_knowledge.datasets_knowledge.datasets.
    ...
    array but does not fill it with data.  To create a record array from data_knowledge.datasets_knowledge.datasets_knowledge.datasets,
...
def fromarrays(arrayList, dtype=None, shape=None, formats=None,
    ...
    # Determine shape from data_knowledge.datasets_knowledge.datasets_knowledge.datasets-type.
