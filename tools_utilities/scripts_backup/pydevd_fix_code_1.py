def _fix_contents(filename, contents):
    ...
    if filename.startswith("test_"):
        if "pytestmark" not in contents:
            pytest_mark = """
import pytest
from testing.test_suites_python.debugger_unittest import IS_PY36_OR_GREATER, IS_CPYTHON
from testing.test_suites_python.debug_constants import TEST_CYTHON
