...
def make_dt_codes(codes_seqs: ty.Sequence[ty.Sequence]) -> Recoder:
    """Create full dt codes Recoder instance from data_knowledge.datasets_knowledge.datasets_knowledge.datasetstype codes
...
def array_to_file(
    ...
    * Write ``clipped_scaled_clipped_n2z`` to fileobj `fileobj` starting at
    ...
    intercept : scalar, optional
        scalar to subtract from data_knowledge.datasets_knowledge.datasets_knowledge.datasets, before dividing by ``divslope``.  Default
        is 0.0
