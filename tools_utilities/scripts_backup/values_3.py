...
class PerWorkerDatasetFromDatasetFunction(object):
  """Represents worker-distributed datasets created from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsset function."""

  def __init__(self, dataset_fn, coordinator):
    """Makes an iterable from data_knowledge.datasets_knowledge.datasets_knowledge.datasetssets created by the given function.
...
class PerWorkerDatasetFromDataset(PerWorkerDatasetFromDatasetFunction):
  ...
  def __init__(self, dataset, coordinator):
    """Makes an iterable from data_knowledge.datasets_knowledge.datasets_knowledge.datasetssets created by the given dataset.
