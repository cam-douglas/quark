...
def blob_dog(
    ...
    *,
    ...
    Examples
    --------
    >>> from skimage import data_knowledge.datasets_knowledge.datasets_knowledge.datasets, feature
    >>> coins = data.coins()
...
def blob_log(
    ...
    *,
    ...
    Examples
    --------
    >>> from skimage import data_knowledge.datasets_knowledge.datasets_knowledge.datasets, feature, exposure
    >>> img = data.coins()
