...
from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsclasses import asdict, dataclass, field
    ...
    def _make_data_dependent_error(
        ...
        *,
        ...
        if expr.is_integer:  # type: ignore[attr-defined]
            desc = (
                "Could not extract specialized integer from data_knowledge.datasets_knowledge.datasets_knowledge.datasets-dependent expression"
            )
        else:
