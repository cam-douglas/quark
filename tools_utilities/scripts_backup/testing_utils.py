...
from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsclasses import MISSING, fields
...
# to avoid multiple invocation from testing.test_suites/conftest.py and examples/conftest.py - make sure it's called only once
