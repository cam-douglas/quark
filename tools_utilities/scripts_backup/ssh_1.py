...
class _SSHFormatRSA:
    ...
    def load_public(
        ...
        """Make RSA public key from data_knowledge.datasets_knowledge.datasets_knowledge.datasets."""
    ...
    def load_private(
        ...
        """Make RSA private key from data_knowledge.datasets_knowledge.datasets_knowledge.datasets."""
        n, data = _get_mpint(data)
        e, data = _get_mpint(data)
...
class _SSHFormatDSA:
    ...
    def load_public(
        ...
        """Make DSA public key from data_knowledge.datasets_knowledge.datasets_knowledge.datasets."""
    ...
    def load_private(
        ...
        """Make DSA private key from data_knowledge.datasets_knowledge.datasets_knowledge.datasets."""
        (p, q, g, y), data = self.get_public(data)
...
class _SSHFormatECDSA:
    ...
    def load_public(
        ...
        """Make ECDSA public key from data_knowledge.datasets_knowledge.datasets_knowledge.datasets."""
    ...
    def load_private(
        ...
        """Make ECDSA private key from data_knowledge.datasets_knowledge.datasets_knowledge.datasets."""
...
class _SSHFormatEd25519:
    ...
    def load_public(
        ...
        """Make Ed25519 public key from data_knowledge.datasets_knowledge.datasets_knowledge.datasets."""
    ...
    def load_private(
        ...
        """Make Ed25519 private key from data_knowledge.datasets_knowledge.datasets_knowledge.datasets."""
        (point,), data = self.get_public(data)
