...
if TYPE_CHECKING:
    from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsbricks.sdk import WorkspaceClient
    from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsbricks.sdk.service.catalog import FunctionInfo, FunctionParameterInfo
    from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsbricks.sdk.service.sql import StatementParameterListItem
...
def is_scalar(function: "FunctionInfo") -> bool:
    ...
    """
    from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsbricks.sdk.service.catalog import ColumnTypeName
...
def execute_function(
    ...
    from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsbricks.sdk.service.sql import StatementState
