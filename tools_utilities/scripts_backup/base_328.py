...
from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsclasses import data_knowledge.datasets_knowledge.datasets_knowledge.datasetsclass, fields, field
import textwrap
...
class Mappable:
    def __init__(
        ...
        """
        Property that can be mapped from data_knowledge.datasets_knowledge.datasets_knowledge.datasets or set directly, with flexible defaults.
