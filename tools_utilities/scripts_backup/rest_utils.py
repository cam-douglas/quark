...
from mlflow.protos import data_knowledge.datasets_knowledge.datasets_knowledge.datasetsbricks_pb2
...
def http_request(
    ...
    **kwargs,
    ...
    if host_creds.use_databricks_sdk:
        from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsbricks.sdk.errors import DatabricksError
