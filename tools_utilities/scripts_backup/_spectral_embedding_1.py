...
class SpectralEmbedding(BaseEstimator):
    ...
    def _get_affinity_matrix(self, X, Y=None):
        """Calculate the affinity matrix from data_knowledge.datasets_knowledge.datasets_knowledge.datasets
        Parameters
        ----------
    ...
    def fit(self, X, y=None):
        """Fit the model from data_knowledge.datasets_knowledge.datasets_knowledge.datasets in X.
    ...
    def fit_transform(self, X, y=None):
        """Fit the model from data_knowledge.datasets_knowledge.datasets_knowledge.datasets in X and transform X.
