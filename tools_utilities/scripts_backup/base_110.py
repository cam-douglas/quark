...
class PipelineDataFormat:
    ...
    `PipelineDataFormat` also includes some utilities to work with multi-columns like mapping from data_knowledge.datasets_knowledge.datasets_knowledge.datasetssets columns to
