...
def infer_module_for_data_files(
    ...
    """Infer module (and builder kwargs) from data_knowledge.datasets_knowledge.datasets_knowledge.datasets files. Raise if module names for different splits don't match.
...
class HubDatasetModuleFactory(_DatasetModuleFactory):
    """
    Get the module of a dataset loaded from data_knowledge.datasets_knowledge.datasets_knowledge.datasets files of a dataset repository.
...
def load_dataset_builder(
    ...
    **config_kwargs,
    ...
    ```py
    >>> from data_knowledge.datasets_knowledge.datasets_knowledge.datasetssets import load_dataset_builder
...
def load_from_disk(
    ...
    ```py
    >>> from data_knowledge.datasets_knowledge.datasets_knowledge.datasetssets import load_from_disk
