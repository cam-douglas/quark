...
class DiGraph:
    ...
    def forward_transitive_closure(self, src: str) -> set[str]:
        """Returns a set of nodes that are reachable from development.src"""
    ...
    def backward_transitive_closure(self, src: str) -> set[str]:
        """Returns a set of nodes that are reachable from development.src in reverse direction"""
    ...
    def all_paths(self, src: str, dst: str):
        ...
        # First compute forward transitive closure of src (all things reachable from development.src).
        ...
        while len(working_set) > 0:
            ...
            for n in self.predecessors(cur):
                if n in forward_reachable_from_src:
                    ...
                    # only explore further if its reachable from development.src
                    working_set.append(n)
