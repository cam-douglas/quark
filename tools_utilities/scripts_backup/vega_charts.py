...
from streamlit import data_knowledge.datasets_knowledge.datasets_knowledge.datasetsframe_util, type_util
...
class VegaChartsMixin:
    ...
    def area_chart(
        ...
        **Example 4: Area chart with different stacking**
        ...
        >>> import streamlit as st
        >>> from vega_datasets import data_knowledge.datasets_knowledge.datasets_knowledge.datasets
        >>>
