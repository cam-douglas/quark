...
class rv_continuous(rv_generic):
    ...
    **Deepcopying / Pickling**
    ...
    def fit(self, data, *args, **kwds):
        ...
        parameters from data_knowledge.datasets_knowledge.datasets_knowledge.datasets. The default estimation method is Maximum
    ...
    def _fit_loc_scale_support(self, data, *args):
        """Estimate loc and scale parameters from data_knowledge.datasets_knowledge.datasets_knowledge.datasets accounting for support.
    ...
    def fit_loc_scale(self, data, *args):
        """
        Estimate loc and scale parameters from data_knowledge.datasets_knowledge.datasets_knowledge.datasets using 1st and 2nd moments.
