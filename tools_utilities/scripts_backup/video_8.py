...
class Video:
    ...
    ```py
    >>> from data_knowledge.datasets_knowledge.datasets_knowledge.datasetssets import Dataset, Video
...
def encode_torchcodec_video(video: "VideoDecoder") -> Example:
    if hasattr(video, "_hf_encoded"):
        ...
        raise NotImplementedError(
            "Encoding a VideoDecoder that doesn't come from data_knowledge.datasets_knowledge.datasets_knowledge.datasetssets.Video.decode() is not implemented"
        )
