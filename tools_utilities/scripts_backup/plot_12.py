...
class Plot:
    ...
    into multiple subplots. The mappings from data_knowledge.datasets_knowledge.datasets_knowledge.datasets values to visual properties
    ...
    def scale(self, **scales: Scale) -> Plot:
        """
        Specify mappings from data_knowledge.datasets_knowledge.datasets_knowledge.datasets units to visual properties.
