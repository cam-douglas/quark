...
def get_class(**kwargs):
    ...
    2. get_dt_container_cls will get the container class from data_knowledge.datasets_knowledge.datasets_knowledge.datasets type specification. If it is None,
