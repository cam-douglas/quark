...
###############################################################################
# Estimate from data_knowledge.datasets_knowledge.datasets_knowledge.datasets
...
def _regularized_covariance(
    ...
    *,
    ...
    """Compute a regularized covariance from data_knowledge.datasets_knowledge.datasets_knowledge.datasets using sklearn.
