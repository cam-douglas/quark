...
from mypy.plugins import data_knowledge.datasets_knowledge.datasets_knowledge.datasetsclasses as dataclasses_plugin
...
class TypeChecker(NodeVisitor[None], TypeCheckerSharedApi):
    ...
    def check_method_override(
        ...
        check_override_compatibility = (
            ...
            and (
                # don't check override for synthesized __replace__ methods from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsclasses
