...
class DisksOperations:
    ...
    def _create_or_update_initial(
        ...
        api_version: str = kwargs.pop("api_version", _params.pop("api-version", self._api_version or "2022-03-02"))
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
    ...
    def begin_create_or_update(
        ...
        :type disk: ~azure.mgmt.compute.v2022_03_02.models.Disk or IO[bytes]
        :return: An instance of LROPoller that returns either Disk or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2022_03_02.models.Disk]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update(
        ...
        :type disk: ~azure.mgmt.compute.v2022_03_02.models.DiskUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either Disk or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2022_03_02.models.Disk]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_grant_access(
        ...
        **kwargs: Any
        ...
        :type grant_access_data: ~azure.mgmt.compute.v2022_03_02.models.GrantAccessData or IO[bytes]
        :return: An instance of LROPoller that returns either AccessUri or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2022_03_02.models.AccessUri]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
...
class DiskAccessesOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type disk_access: ~azure.mgmt.compute.v2022_03_02.models.DiskAccess or IO[bytes]
        :return: An instance of LROPoller that returns either DiskAccess or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2022_03_02.models.DiskAccess]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type disk_access: ~azure.mgmt.compute.v2022_03_02.models.DiskAccessUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either DiskAccess or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2022_03_02.models.DiskAccess]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update_a_private_endpoint_connection(  # pylint: disable=name-too-long
        ...
        **kwargs: Any
        ...
        :type private_endpoint_connection:
         ~azure.mgmt.compute.v2022_03_02.models.PrivateEndpointConnection or IO[bytes]
        :return: An instance of LROPoller that returns either PrivateEndpointConnection or the result
         of cls(response)
        :rtype:
         ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2022_03_02.models.PrivateEndpointConnection]
...
class DiskEncryptionSetsOperations:
    ...
    def begin_create_or_update(
        ...
        **kwargs: Any
        ...
        :type disk_encryption_set: ~azure.mgmt.compute.v2022_03_02.models.DiskEncryptionSet or
         IO[bytes]
        :return: An instance of LROPoller that returns either DiskEncryptionSet or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2022_03_02.models.DiskEncryptionSet]
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :param disk_encryption_set: disk encryption set object supplied in the body of the Patch disk
         ...
         Required.
        :type disk_encryption_set: ~azure.mgmt.compute.v2022_03_02.models.DiskEncryptionSetUpdate or
         IO[bytes]
        :return: An instance of LROPoller that returns either DiskEncryptionSet or the result of
         cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2022_03_02.models.DiskEncryptionSet]
...
class SnapshotsOperations:
    ...
    def begin_create_or_update(
        ...
        :type snapshot: ~azure.mgmt.compute.v2022_03_02.models.Snapshot or IO[bytes]
        :return: An instance of LROPoller that returns either Snapshot or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2022_03_02.models.Snapshot]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
    ...
    def begin_update(
        ...
        **kwargs: Any
        ...
        :type snapshot: ~azure.mgmt.compute.v2022_03_02.models.SnapshotUpdate or IO[bytes]
        :return: An instance of LROPoller that returns either Snapshot or the result of cls(response)
        :rtype: ~azure.core.polling.LROPoller[~azure.mgmt.compute.v2022_03_02.models.Snapshot]
        :raises ~azure.core.exceptions.HttpResponseError:
        """
