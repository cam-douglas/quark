from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsclasses import fields, is_dataclass
...
def _hydrate_dataclass(dataclass_type, data):
    """Recursively create an instance of the dataclass_type from data_knowledge.datasets_knowledge.datasets_knowledge.datasets."""
