...
def _props_to_dict(regions, properties=('label', 'bbox'), separator='-'):
    ...
    Examples
    --------
    >>> from skimage import data_knowledge.datasets_knowledge.datasets_knowledge.datasets, util, measure
    >>> image = data.coins()
...
def regionprops(
    ...
    **solidity** : float
    ...
    Examples
    --------
    >>> from skimage import data_knowledge.datasets_knowledge.datasets_knowledge.datasets, util
