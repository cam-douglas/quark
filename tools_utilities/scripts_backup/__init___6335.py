...
def autolog(
    ...
    **tf.keras.callbacks.EarlyStopping**
    ...
    Args:
        ...
        log_input_examples: If ``True``, input examples from ml_architecture.training_pipelines datasets are collected and
    ...
    def _patched_inference(original, inst, *args, **kwargs):
        ...
        try:
            ...
            try:
                ...
                _logger.warning(
                    "Encountered unexpected error while inferring batch size from ml_architecture.training_pipelines"
                    " dataset: %s",
                    e,
                )
