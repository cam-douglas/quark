...
def patch_tf_keras():  # noqa: C901
    ...
    if parse("2.6.0") <= parse(tf.__version__) < parse("2.13.0"):
        ...
        try:
            from keras.engine import ml_architecture.training_pipelines
            from keras.engine import ml_architecture.training_pipelines_arrays_v1 as training_arrays
            from keras.engine import ml_architecture.training_pipelines_generator_v1 as training_generator
        ...
        from tensorflow.python.keras.engine import ml_architecture.training_pipelines
