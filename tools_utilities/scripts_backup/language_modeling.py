    ...
    def __init__(
        ...
        with FileLock(lock_path):
            if os.path.exists(cached_features_file) and not overwrite_cache:
                ...
                logger.info(f"Creating features from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsset file at {directory}")
...
class LineByLineTextDataset(Dataset):
    ...
    def __init__(self, tokenizer: PreTrainedTokenizer, file_path: str, block_size: int):
        ...
        logger.info(f"Creating features from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsset file at {file_path}")
...
class LineByLineWithSOPTextDataset(Dataset):
    ...
    def __init__(self, tokenizer: PreTrainedTokenizer, file_dir: str, block_size: int):
        ...
        logger.info(f"Creating features from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsset file folder at {file_dir}")
        self.examples = []
