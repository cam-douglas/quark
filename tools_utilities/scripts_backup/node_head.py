...
class NodeHead(SubprocessModule):
    ...
    async def dump(self, req) -> aiohttp.web.Response:
        """
        Dump all data from data_knowledge.datasets_knowledge.datasets_knowledge.datasetscenter. This is used for testing purpose only.
        """
        ...
        if key is None:
            ...
            return dashboard_optional_utils.rest_response(
                status_code=dashboard_utils.HTTPStatusCode.OK,
                message="Fetch all data from data_knowledge.datasets_knowledge.datasets_knowledge.datasetscenter success.",
                **all_data,
            )
        else:
            ...
            return dashboard_optional_utils.rest_response(
                status_code=dashboard_utils.HTTPStatusCode.OK,
                message=f"Fetch {key} from data_knowledge.datasets_knowledge.datasets_knowledge.datasetscenter success.",
                **{key: data},
            )
