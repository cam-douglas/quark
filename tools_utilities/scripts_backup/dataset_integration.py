...
try:
    from data_knowledge.datasets_knowledge.datasets_knowledge.datasetssets import load_dataset, interleave_datasets, Dataset, IterableDataset
    from data_knowledge.datasets_knowledge.datasets_knowledge.datasetssets.utils.logging import set_verbosity_error
    # Suppress verbose logging from data_knowledge.datasets_knowledge.datasets_knowledge.datasetssets library
    set_verbosity_error()
except ImportError:
...
class DatasetIntegrator:
    ...
    def get_dataset_info(self, dataset_name: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            from data_knowledge.datasets_knowledge.datasets_knowledge.datasetssets import get_dataset_config_names, get_dataset_split_names
