...
Most are constructed upon import from data_knowledge.datasets_knowledge.datasets_knowledge.datasets in otData.py, all are populated with
...
def _read_uint32var(data, i):
    """Read a variable-length number from data_knowledge.datasets_knowledge.datasets_knowledge.datasets starting at index i.
