...
from dask.dataframe.dask_expr._backends import data_knowledge.datasets_knowledge.datasets_knowledge.datasetsframe_creation_dispatch
...
def from_map(
    ...
    **kwargs,
    ...
    ``from_map`` is the preferred option when reading from data_knowledge.datasets_knowledge.datasets_knowledge.datasets sources
