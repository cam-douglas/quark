...
def is_hf_dataset(dataset):
    ...
    from data_knowledge.datasets_knowledge.datasets_knowledge.datasetssets import Dataset, IterableDataset
...
class TrainingSummary:
    ...
    def from_trainer(
        ...
        # Infer default from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsset
