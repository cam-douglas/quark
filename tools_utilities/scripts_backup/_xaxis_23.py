...
class XAxis(_BaseLayoutHierarchyType):
    ...
    def showspikes(self):
        """
        Sets whether or not spikes starting from data_knowledge.datasets_knowledge.datasets_knowledge.datasets points to this
    ...
    def _prop_descriptions(self):
        ...
        showline
            ...
            drawn.
        showspikes
            Sets whether or not spikes starting from data_knowledge.datasets_knowledge.datasets_knowledge.datasets points to
