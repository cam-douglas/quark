...
if TYPE_CHECKING:
    from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsbricks.sdk.service.files import FilesAPI
...
class DatabricksSdkArtifactRepository(ArtifactRepository):
    def __init__(self, artifact_uri: str, tracking_uri: Optional[str] = None) -> None:
        ...
        from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsbricks.sdk.config import Config
    ...
    def _is_dir(self, path: str) -> bool:
        from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsbricks.sdk.errors.platform import NotFound
