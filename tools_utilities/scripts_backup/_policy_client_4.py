...
class PolicyClient:
    ...
    :vartype policy_assignments:
     azure.mgmt.resource.policy.v2018_05_01.operations.PolicyAssignmentsOperations
    :ivar policy_definitions: PolicyDefinitionsOperations operations
    :vartype policy_definitions:
     azure.mgmt.resource.policy.v2018_05_01.operations.PolicyDefinitionsOperations
