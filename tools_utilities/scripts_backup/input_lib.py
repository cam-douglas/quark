...
def get_iterator_spec_from_dataset(strategy, dataset):
  """Returns an iterator spec from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsset function.
...
class DistributedDatasetsFromFunction(_IterableInput,
                                      composite_tensor.CompositeTensor):
  """Inputs created from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsset function."""
