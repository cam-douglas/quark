import param
from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsshader.bundling import (
...
class bundle_graph(_connect_edges, hammer_bundle):
    ...
    def _bundle(self, position_df, edges_df):
        from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsshader.bundling import hammer_bundle
