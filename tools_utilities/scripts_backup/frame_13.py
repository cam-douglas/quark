...
class DataFrame(NDFrame, OpsMixin):
    ...
    Constructing DataFrame from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsclass:

    >>> from data_knowledge.datasets_knowledge.datasets_knowledge.datasetsclasses import make_dataclass
