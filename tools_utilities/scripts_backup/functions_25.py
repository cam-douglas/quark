...
FUNCTIONS: Mapping[str, FunctionDecl] = dict([
    ...
    ('mjr_blitBuffer',
     FunctionDecl(
         ...
         doc='Blit from development.src viewpoint in current framebuffer to dst viewport in other framebuffer. If src, dst have different size and flg_depth==0, color is interpolated with GL_LINEAR.',  # pylint: disable=line-too-long
     )),
    ('mjr_setAux',
     FunctionDecl(
         name='mjr_setAux',
