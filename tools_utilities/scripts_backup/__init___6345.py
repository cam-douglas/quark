...
from mlflow.utils import data_knowledge.datasets_knowledge.datasets_knowledge.datasetsbricks_utils
...
def log_model(
    ...
    Args:
        ...
        signature: :py:class:`ModelSignature <mlflow.models.ModelSignature>`
            ...
            from data_knowledge.datasets_knowledge.datasets_knowledge.datasetssets with valid model input (e.g. the training dataset with target
