...
class EpisodicMemory:
    ...
    def store_episode(self, content: Dict[str, Any], context: Dict[str, Any],
        ...
        # Capacity management is now handled by an external process (e.g., during sleep cycles)
    ...
    def trigger_consolidation_cycle(self):
        """
        Consolidates memories to manage capacity, typically during a sleep-like state.
        Removes least important and least accessed memories to stay within capacity.
        """
    ...
    def inject_knowledge(self, knowledge: "KnowledgeObject"):
        """
        Injects a declarative KnowledgeObject directly into episodic memory.
        """
        # We treat the injected knowledge as a high-importance memory
        self.store_episode(
            content=knowledge.content,
            context={"source": knowledge.source, "citation": knowledge.citation},
            importance=0.9, # Injected knowledge is considered important
            emotional_valence=0.1 # Typically neutral to positive
        )
