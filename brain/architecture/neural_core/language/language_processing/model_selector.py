    ...
    def _query_gpt_selector(self, prompt: str, available_models: List[str]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            system_msg = (
                ...
                "Consider: complexity, domain expertise needed, response style, computational requirements. "
                "Return strict JSON with: {\"provider\": \"service:model\", \"reason\": \"explanation\", \"confidence\": 0.0-1.0}. "
                "Available models format: 'service:model' (e.g., 'openai:gpt-4o', 'anthropic:claude-3-opus-20240229'). "
                "Local models: 'local:flan-t5-base', 'local:conversation', 'local:qa'. "
                "Preferences: "
                "- Complex reasoning/coding: GPT-4o "
                "- Safety-critical/nuanced: Claude-3-opus "
                "- Fast general queries: Gemini-1.5-flash "
                "- Simple chat: local models "
                "- Scientific analysis: Claude-3-sonnet "
