...
class ExpertRouter:
    ...
    def get_expert_preferences(self, intent: str) -> Dict[str, float]:
        ...
        preferences = {
            'general_conversation': {'openai': 0.4, 'anthropic': 0.3, 'gemini': 0.3},
            'scientific_analysis': {'anthropic': 0.5, 'openai': 0.3, 'gemini': 0.2},
            'creative_writing': {'openai': 0.5, 'anthropic': 0.3, 'gemini': 0.2},
            'technical_explanation': {'anthropic': 0.4, 'openai': 0.4, 'gemini': 0.2},
            'problem_solving': {'openai': 0.4, 'anthropic': 0.4, 'gemini': 0.2},
            'learning_assistance': {'anthropic': 0.4, 'openai': 0.3, 'gemini': 0.3}
        }
        
        return preferences.get(intent, {'openai': 0.4, 'anthropic': 0.3, 'gemini': 0.3})
