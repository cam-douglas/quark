...
from state.quark_state_system.command_handlers import (
    run_quick_status, run_recommendations, run_sync, run_autonomous_agent,
    ...
    handle_update_roadmap, handle_add_chat_task
)
from state.quark_state_system.system_overview import show_system_overview, show_help
from state.quark_state_system.chat_task_manager import create_chat_tasks, task_status
...
# Legacy compatibility - maintain old CLI hooks for backward compatibility
