...
try:
    from 📊_DATA_KNOWLEDGE.01_DATA_REPOSITORYsets import load_dataset, interleave_datasets, Dataset, IterableDataset
    from 📊_DATA_KNOWLEDGE.01_DATA_REPOSITORYsets.utils.logging import set_verbosity_error
    # Suppress verbose logging from 📊_DATA_KNOWLEDGE.01_DATA_REPOSITORYsets library
    set_verbosity_error()
except ImportError:
...
class DatasetIntegrator:
    ...
    def get_dataset_info(self, dataset_name: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            from 📊_DATA_KNOWLEDGE.01_DATA_REPOSITORYsets import get_dataset_config_names, get_dataset_split_names
